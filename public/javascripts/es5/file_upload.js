...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)('.submit').on('click', function () {
	    var path = showPic((0, _jquery2.default)('#fileUpload')[0]);
	    alert(path);
	...
	(0, _jquery2.default)('.modal-default-button').on('click', function () {
	    alert('0000000');
	    var formData = new FormData((0, _jquery2.default)("#uploadForm")[0]);
